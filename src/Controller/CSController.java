...
public class CSController {
	...
	private static void updateCustomer() {
		...
		if(updateFlag) {
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("»õ·Î¿î ¾ÆÀÌµð¸¦ ÀÔ·ÂÇÏ¼¼¿ä>>");
				String newId = scanner.next();
				newId = checkUserId(newId);
				csService.updateId(newId, customerId);
				System.out.println("´Ù½Ã ·Î±×ÀÎÇÏ¼¼¿ä");
				login();
				break;
			case 4:
	...
	private static void displayCustomerInfo() {
		System.out.println("=============================================================================");
		System.out.println("1.ÀÌ¸§ º¯°æ | 2. ÀüÈ­¹øÈ£ º¯°æ | 3. ¾ÆÀÌµð º¯°æ | 4. ºñ¹Ð¹øÈ£ º¯°æ | 5. ¸éÇã º¯°æ | 6. µÚ·Î°¡±â");
		System.out.println("=============================================================================");
...
//		csService.updateTollId(customer_phone, ss);
	...
	public static void displayFirst() {
		System.out.println("============================================================");
		System.out.println("1.·Î±×ÀÎ | 2.È¸¿ø°¡ÀÔ | 3.·Î±×¾Æ¿ô | 4.È¸¿øÅ»Åð | 5.È¸¿øÁ¤º¸Á¶È¸ | 6.Á¾·á");
		System.out.println("============================================================");
	}
	
	public static void displayMenu() {
		System.out.println("==================================================================================");
		System.out.println("1.¿¹¾àÈ®ÀÎ | 2.¹Ý³³ÇÏ±â | 3. ¿¹¾àÇÏ±â | 4.´ë¿© ½Ã°£ Ãß°¡ | 5.È¸¿øÁ¤º¸º¯°æ | 6.È¸¿øÁ¤º¸Á¶È¸ | 7.µÚ·Î°¡±â");
		System.out.println("==================================================================================");
